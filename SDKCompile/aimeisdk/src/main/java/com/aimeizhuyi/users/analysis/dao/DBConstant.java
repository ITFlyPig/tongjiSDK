...
public class DBConstant {
    ...
    public static final String LOG_EXCEPTION_TABLE_BANE = "exception_table";
    ...
    public static final String CREATE_EXCEPTION_DATA_TABLE = "create table IF NOT EXISTS " + LOG_EXCEPTION_TABLE_BANE + "(id INTEGER PRIMARY KEY AUTOINCREMENT ,  log_data text);";
}
