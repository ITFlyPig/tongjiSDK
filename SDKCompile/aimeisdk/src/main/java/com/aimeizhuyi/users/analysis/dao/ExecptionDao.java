 ...
 */
public class ExecptionDao {
    private String TAG = "ExecptionDao.class";
    ...
    public ExecptionDao(Context context) {
    ...
    public boolean insert(LogDataBean logDataBean){
        ...
        String sql = "insert into "+DBConstant.LOG_EXCEPTION_TABLE_BANE+"(log_data) values(?)";
    ...
    public boolean delete(String id){
        ...
        String sql = "delete from "+DBConstant.LOG_EXCEPTION_TABLE_BANE+" where id = ?";

        try {
            if(Config.isDebug)
        	Log.i(TAG, "删除的数据：id"+id);
    ...
    public boolean deleteAll(){
        ...
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        String sql = "delete from " + DBConstant.LOG_EXCEPTION_TABLE_BANE;
    ...
    public int getLogCount(){
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        String sql = "select count(*) from "+DBConstant.LOG_EXCEPTION_TABLE_BANE;
        Cursor cursor = null;
    ...
    public ArrayList<LogDataBean> getAll(){
        ...
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        String sql = "select * from "+ DBConstant.LOG_EXCEPTION_TABLE_BANE;
        Cursor cursor = null;
